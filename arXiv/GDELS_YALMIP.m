...
[s8, v8] = polynomial([fs fk fp xs xk xp gk gp],0);

% feasible set
F = [sos(obj-[s1 s2 s3 s4 s5 s6 s7 s8]*[c1; c2; c3; c4; c5; c6; c7; c8]), ...
    sos(s1), sos(s2),sos(s3),sos(s4),sos(s5),sos(s6)];
[sol,v,Q] = solvesos(F,t,[],[v1;v2;v3;v4;v5;v6;v7;v8;t]);